...
var StyledBorderStyleSolid = styled.i(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  &{transform:scale(var(--ggs,1));}&,&::before{box-sizing:border-box;position:relative;display:block;width:26px;height:17px}&::before{content:\"\";position:absolute;height:2px;top:7px;border-top:2px solid}\n"], ["\n  &{transform:scale(var(--ggs,1));}&,&::before{box-sizing:border-box;position:relative;display:block;width:26px;height:17px}&::before{content:\"\";position:absolute;height:2px;top:7px;border-top:2px solid}\n"])));
export var BorderStyleSolid = React.forwardRef(function (props, ref) {
    return (React.createElement(React.Fragment, null,
        React.createElement(StyledBorderStyleSolid, __assign({}, props, { ref: ref }))));
});
